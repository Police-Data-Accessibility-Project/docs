...
Richard was hard at work and created a foreign data wrapper (FDW) to access a cloned dolt instance and copy the data into our own [PostgreSQL instance](../../activities/submit-or-update-datasets/explore-pdap-data-sources/hadoop-datasets-mirror.md) that our applications run on.
